...
User: [Нажимает "Страны поиска"]
Bot: Доступные страны:
     🇷🇺 RU - Россия
     🇰🇿 KZ - Казахстан
     🇧🇾 BY - Беларусь
     🇺🇿 UZ - Узбекистан
...
1. Сохранение фильтров:
   - Фильтры сохраняются в рамках сессии расширенного поиска
   - При каждом действии показываются текущие параметры
   - Возможность изменить любой параметр в любой момент
   - Сброс при выходе из расширенного поиска
...
3. Навигация:
   - Кнопки для выбора параметров всегда доступны
   - Возможность пропуска любого параметра
   - Отображение текущего состояния всех фильтров
