...
2. Реализовать диалоговый flow для `/advanced_search`:
   - Кнопки выбора стран (multiple choice)
   - Поиск и выбор МПК/СПК рубрик
   - Выбор ретроспективы (15/20/25 лет)
3. Реализовать FSM (Finite State Machine) для хранения состояния диалога
4. Добавить возможность сброса фильтров
...
3. Добавить справочники:
   - Список доступных стран
   - Классификатор МПК/СПК
   - Расчет дат для ретроспективы

**Результат:**  
- Пользователь может:
  1. Использовать быстрый поиск через `/search`
  2. Использовать расширенный поиск через `/advanced_search`
  3. Настраивать и сохранять предпочтительные фильтры
